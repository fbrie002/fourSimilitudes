...
function setup() {
    ...
    canvas.parent('sympatheia-sketch');
...
function draw() {
    ...
    for (var i = 0; i < heads.length; i++) {
        ...
        target = createVector(sketchWidth / 2, sketchHeight / 2); //the target is the origin, they want to go back to it
...
function Head() {
    ...
    this.loc = createVector(sketchWidth / 2, sketchHeight / 2);
    this.mass = 3;
